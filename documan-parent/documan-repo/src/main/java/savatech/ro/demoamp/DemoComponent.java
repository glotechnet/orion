...
public class DemoComponent extends AbstractModuleComponent {
  ...
  /**
   * This is a demo service interaction with Alfresco Foundation API. This sample method returns the
   * number of child nodes of a certain type under a certain node.
   *
   * @return
   */
